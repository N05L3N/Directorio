...
function validaCampos(formaltas){


if(vacio(formaltas.nombre1.value))
alert("El campo: [1er Nombre] no puede estar vacio");

else if(vacio(formaltas.apellido1.value))
alert("El campo: [Apellido Paterno] no puede estar vacio");

else if(vacio(formaltas.puesto.value))
alert("El campo: [Puesto] no puede estar vacio");

else if(vacio(formaltas.departamento.value))
alert("El campo: [Departamento] no puede estar vacio");

else if(vacio(formaltas.sucursal.value))
alert("El campo: [Sucursal] no puede estar vacio");

else if(vacio(formaltas.ext.value))
alert("El campo: [Extensión] no puede estar vacio");
...
function enviar() { 
//validaCampos(); 
document.getElementById("formaltas").submit(); 
} 